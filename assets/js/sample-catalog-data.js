...
const SAMPLE_PRODUCTS = {
  tour: {
    'sapanca-masukiye': {
      ...
      taxonomy: { categories: ['yurt-ici-turlar'], themes: ['doga-yayla'], collections: ['ailece'],
    ...
    'iznik-golu-antik-kent': {
      ...
      taxonomy: { categories: ['yurt-ici-turlar'], themes: ['kultur-tarih', 'doga-yayla'], collections: [],
    ...
    'erciyes-kayak-haftasi': {
      ...
      taxonomy: { categories: ['yurt-ici-turlar'], themes: ['kis-sporlari'], collections: ['arkadas-grubu'],
    ...
    'dogu-ekspresi': {
      ...
      taxonomy: { categories: ['yurt-ici-turlar'], themes: ['kultur-tarih', 'doga-yayla'], collections: ['tek-basina'],
